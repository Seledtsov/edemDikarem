...
********************************************************************************
*/
var $cssYearTable="ac_year"; // table tag: calendar year
var $cssYearTitle="ac_yearname"; // td tag: calendar year title
var $cssYearNav="ac_yearnavigation"; // td tag: calendar year navigation
var $cssMonthTable=""; // table tag: calendar month
var $cssMonthTitle="calendar_top"; // td tag: calendar month title
var $cssMonthNav="ac_monthnavigation"; // td tag: calendar month navigation
var $cssWeekDay="ac_dayname"; // tr tag: calendar weekdays
var $cssPicker="ac_datepicker"; // td tag: date picker
var $cssPickerForm="ac_datepickerform"; // form tag: date picker form
var $cssPickerMonth="ac_monthpicker"; // select tag: month picker
var $cssPickerYear="ac_yearpicker"; // select tag: year picker
var $cssPickerButton="ac_pickerbutton"; // input (submit) tag: date picker button
var $cssMonthDay="ac_monthday"; // td tag: days, that belong to the current month
var $cssNoMonthDay="ac_nomonthday"; // td tag: days, that do not belong to the current month
var $cssToday="ac_today"; // td tag: the current day
var $cssSelecDay="ac_selectedday"; // td tag: the selected day
var $cssSunday="ac_sunday"; // td tag: all Sundays (can be disabled, see below)
var $cssSaturday="ac_saturday"; // td tag: all Saturdays (can be disabled, see below)
var $cssEvent="ac_event"; // td tag: event day set by setEvent(). Multiple class names can be generated
var $cssPrefixSelecEvent="ac_selected"; // prefix for the event class name if the event is selected
var $cssPrefixTodayEvent="ac_today"; //  prefix for the event class name if the event is the current day
var $cssEventContent="ac_eventcontent"; // table tag: calendar event content. Multiple class names can be generated
...
*/
function mkYearHead(){
return "<table class=\"".$this->cssYearTable."\" width=\"170\">\n";
}
/*
********************************************************************************
...
function mkYearTitle(){
	...
	if (!$this->yearNav){
		...
		$out.="<table width=\"170\"><tr><td class=\"".$this->cssYearNav."\">";
...
return "<table class=\"".$this->cssMonthTable."\" width=\"170\">\n";
}
/*
********************************************************************************
...
function mkMonthTitle(){
	if (!$this->monthNav){
		...
		$out.="<strong>".$this->getMonthName().",".$this->monthYearDivider.$this->actyear;
		$out.="</strong></td></tr>\n";
	}
	else{
...
function mkWeekDays(){
	if ($this->startOnSun){
		$out="<tr class=\"clbrd\"><td>".$this->getDayName(0)."</td>";
		...
		for ($x=0;$x<count($hasContent);$x++){
			foreach($hasContent[$x] as $eventContentid => $eventContentData){
				foreach($eventContentData as $eventContentUrl => $eventContent){
					$out.="<table class=\"".$eventContentid."\" width=\"170\">";
